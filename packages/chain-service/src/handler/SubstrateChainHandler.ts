...
import { typesBundle, typesChain } from '@subwallet/chain-list/api-helper/index';
import { _AssetType } from '@subwallet/chain-list/types';
import { _SubstrateChainSpec } from '@subwallet/chain-service/handler/types';
import { _PSP22_ABI, _PSP34_ABI } from '@subwallet/chain-service/helper/index';
import { _SmartContractTokenInfo, _SubstrateApi, _SubstrateChainMetadata } from '@subwallet/chain-service/types';
...
export class SubstrateChainHandler {
  ...
  public initApi (chainSlug: string, apiUrl: string): _SubstrateApi {
    ...
    const apiOption = { provider, typesBundle, typesChain };
